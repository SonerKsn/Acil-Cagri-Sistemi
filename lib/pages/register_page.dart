...
// telefona gelen kodu doğrulama metodu
  Future<void> verifyOTP() async {
    await controller.auth
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => KurumOlayBilgisi(),
        ),
      );
    });
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // ilk açılışsa screenState 0 olur ve register sayfası gelir kullanıcı telefon no ve adını soy adını girince
                        //stateOTP widgeti çalışır o widgetta ise doğrulama kodunu girilen kısım yönlendirilir.
      ...
      children: [
        RichText(
          ...
          text: TextSpan(
            children: [
              TextSpan(
                text: "Bir Kod Gönderdik ",
              ),
              TextSpan(
                text: countryDial + phoneController.text,
              ),
              TextSpan(
                text: "\nKodu Buraya Girin ve Devam Edin!",
              ),
            ],
          ),
        ),
